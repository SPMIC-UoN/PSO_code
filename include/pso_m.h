...
typedef struct {
  ...
  double error_m;
  double *gbest_m; // should contain DIM elements!!
...
typedef double (*pso_obj_fun_t_m)(double *, int, void *, double *, double *, double *, double *, double *, double *, double *);
...
int pso_calc_swarm_size_m(int dim);
