...
typedef struct {
  ...
  double error_bi;
  double *gbest_bi; // should contain DIM elements!!
...
typedef double (*pso_obj_fun_t_bi)(double *, int, void *, double *, double *);
...
typedef struct {
  ...
  double x_lo[7]; // lower range limit
  double x_hi[7]; // higher range limit
