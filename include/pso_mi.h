...
typedef struct {
  ...
  double error_mi;
  double *gbest_mi; // should contain DIM elements!!
...
typedef double (*pso_obj_fun_t_mi)(double *, int, void *, double *, double *, double *, double *, double *);
...
int pso_calc_swarm_size_mi(int dim);
