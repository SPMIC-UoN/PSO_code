...
typedef struct {
  ...
  double error_d;
  double *gbest_d; // should contain DIM elements!!
...
typedef double (*pso_obj_fun_t_d)(double *, int, void *, double *, double *, double *, double *, double *, double *, double *);
...
int pso_calc_swarm_size_d(int dim);
